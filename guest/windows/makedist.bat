...
copy dist\tickler64.exe "\\vmware-host\Shared Folders\s2e\env\install\bin\guest-tools64"
copy dist\tickler32.exe "\\vmware-host\Shared Folders\s2e\env\install\bin\guest-tools64"
copy dist\tickler32.exe "\\vmware-host\Shared Folders\s2e\env\install\bin\guest-tools32"
